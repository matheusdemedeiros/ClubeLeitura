...
namespace ClubeLeitura.ConsoleApp.ModuloEmprestimo
{
    public class TelaCadastroEmprestimo : TelaBase
    {
        ...
        public void EditarEmprestimo()
        {
            ...
            if (temEmprestimosCadastrados == false)
            {
                notificador.ApresentarMensagem(
                    "Nenhum empréstimo cadastrado para poder editar", TipoMensagem.Atencao);
                return;
            }
            int numeroEmprestimo = ObterNumeroEmprestimo();
        ...
        private Amigo ObtemAmigo()
        {
            ...
            Amigo amigoSelecionado = repositorioAmigo.SelecionarRegistro(numeroAmigoEmprestimo);
        ...
        private Revista ObtemRevista()
        {
            ...
            Revista revistaSelecionada = repositorioRevista.SelecionarRegistro(numeroRevistaEmprestimo);
